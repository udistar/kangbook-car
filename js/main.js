...
function switchMap(mapType) {
    ...
    if (mapType === 'naver') {
        ...
        if (typeof naver !== 'undefined') initNaverMap();
        ...
        if (typeof kakao !== 'undefined') initKakaoMap();
    }
}
...
function initNaverMap() {
    const mapOptions = {
        center: new naver.maps.LatLng(37.9015, 127.0395),
        zoom: 16
    };
    const map = new naver.maps.Map('naver-map-canvas', mapOptions);
    new naver.maps.Marker({
        position: new naver.maps.LatLng(37.9015, 127.0395),
        map: map,
        title: '(주)강북폐차산업'
    });
}
...
function initKakaoMap() {
    ...
    const options = {
        center: new kakao.maps.LatLng(37.9015, 127.0395),
        level: 3
    };
    const map = new kakao.maps.Map(container, options);
    const markerPosition = new kakao.maps.LatLng(37.9015, 127.0395);
